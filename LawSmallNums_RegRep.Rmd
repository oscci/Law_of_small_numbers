...
Finally, if we are able to show an improvement with this short training session, with generalisation to S-items on the quiz, then this would lead us to conclude that the game might be a useful adjunct to statistical training courses for scientists. It would still be of interest to do further studies with modified forms of presentation, to identify the optimum conditions for training. It would also be of interest to evalute the traihning for longer-term impact on subsequent experimental practices of the trainees.   
