...
!["Example of an item where there is a true difference"](gifpilot1.gif)
...
mydf <-rbind(c1,c2,c3,c4)
mydf <- as.data.frame(cbind(c('Block1','Block2','Block3','Block4'),mydf))
...
!["Example of an item from Pilot 2 where there is no true difference"](pilot2_demo.gif)
...
21 participants reported that they had improved over time, with 1 saying they did not and 4 saying they were unsure. As we can see from the qualitative questions a few participants didn't employ a strategy, but several mentioned that they learned to wait longer.  
